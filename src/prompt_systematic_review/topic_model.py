...
"""
Runs the topic model with default parameters used in data/topic-model-data/README.md (MANUAL section). 
Results are found in topic-model-data folder
Runs all topic models (10, 25, 50). If you don't want to run all of them, feel free to comment out below.

Relies on the user being in ./Prompt_Systematic_Review/src/prompt_systematic_review
"""
