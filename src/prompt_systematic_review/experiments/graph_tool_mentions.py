...
def graph_tool_mentions(
    ...
    csv_file = os.path.join(DataFolderPath, modelCitationCountInput)
    ...
    csv_file = os.path.join(DataFolderPath, datasetCitationCountInput)
    df = pd.read_csv(csv_file)
    ...
    csv_file = os.path.join(DataFolderPath, frameworkCitationCountInput)
    df = pd.read_csv(csv_file)
